...
//
//     final getActiveShareRideByDriverModel = getActiveShareRideByDriverModelFromJson(jsonString);

import 'dart:convert';

GetActiveShareRideByDriverModel getActiveShareRideByDriverModelFromJson(
        String str) =>
    GetActiveShareRideByDriverModel.fromJson(json.decode(str));

String getActiveShareRideByDriverModelToJson(
        GetActiveShareRideByDriverModel data) =>
    json.encode(data.toJson());

class GetActiveShareRideByDriverModel {
  int? code;
  String? status;
  Data? data;
  String? message;

  GetActiveShareRideByDriverModel({
    this.code,
    this.status,
    this.data,
    this.message,
  ...
  factory GetActiveShareRideByDriverModel.fromJson(Map<String, dynamic> json) =>
      GetActiveShareRideByDriverModel(
        code: json["code"],
        status: json["status"],
